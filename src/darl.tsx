...
import { App, Opts } from './run'
import { err, ok, Result } from 'libsugar'
...
function check_config_path(config: string) {
    if (config == null) return [
        { name: 'dev.darl', type: 'mjs' },
        { name: 'dev.darl', type: 'js' },
    ]
...
async function try_import(config: string): Promise<Result<any, any[]>> {
